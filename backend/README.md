...
## Project Structure
    ...
    ├── goby_on_demandmarke_30570  # Django project configurations
...
1. Clone this repo and `cd goby_on_demandmarke_30570`
...
2. Clone this repo and `cd goby_on_demandmarke_30570`
